...
set xrange [9:81]
plot '1_err.txt' using 1:3 with linespoints  title "θ=0, µ=0.5",   \
     '2_err.txt' using 1:3 with linespoints  title "θ=1, µ=5",     \
     '3_err.txt' using 1:3 with linespoints  title "θ=0.5, ν=1/20" 
...
plot '1_err.txt' using 2:3 with linespoints  title "θ=0, µ=0.5",   \
     '2_err.txt' using 2:3 with linespoints  title "θ=1, µ=5",     \
     '3_err.txt' using 2:3 with linespoints  title "θ=0.5, ν=1/20" 
